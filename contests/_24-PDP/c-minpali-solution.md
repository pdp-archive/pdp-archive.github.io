...
Μας δίνεται μια συμβολοσειρά χαρακτήρων μήκους $$Ν$$ και μας ζητείται να υπολογίσουμε το μικρότερο μήκος παλίνδρομου που μπορεί να παραχθεί από αυτό ενώ πρέπει οπωσδήποτε η δοσμένη συμβολοσειρά να αποτελεί prefix του τελικού παλίνδρομου   
...
Για τους χαρακτήρες της συμβολοσειρά εισόδου δηλαδή ισχύει ότι $$0 \leq i \leq N-1 < N+i$$ όπου $$i$$ είναι η θέση που ξεκινά το παλίνδρομο, $$N-1$$ ο τελευταίος 
χαρακτήρας της συμβολοσειράς εισόδου και από $$Ν$$ έως τη $$N+i$$ θέση θα πρέπει να προσθέσουμε $$i$$ χαρακτήρες 
...
Το πρόβλημα με την προηγούμενη λύση είναι ότι κάθε φορά που θέλουμε να αρχίσουμε τον έλεγχο από την επόμενη θέση ολισθαίνοντας τα δυo τμήματα του υποψήφιου παλίνδρομου, 
ελέγχουμε από την αρχή τα $$N$$ στοιχεία. Στη λύση που ακολουθεί θα χρησιμοποιήσουμε τον αλγόριθμο Rabin-Karp ο οποίος κατασκευάζει ένα πολυώνυμο το οποίο 
αποτελείται από αθροίσματα μονώνυμων και χρησιμοποιεί την τιμή αυτή για να μπορεί να κάνει σε $$\mathcal{O}(1)$$ συγκρίσεις μεταξύ δύο αλφαριθμητικών. 
Κάθε μονώνυμο είναι γινόμενο ενός χαρακτήρα του αλφαριθμητικού και κάποιας δύναμης ενός σταθερού αριθμού $$C$$. 
Λόγω των μεγάλων εκθετών που χρησιμοποιεί το πολυώνυμο για αλφαριθμητικά μεγέθους $$\mathit{MAXN}$$ δηλαδή $$10^7$$, θα ξεπεράσει το όριο των τύπων ακεραίων 
που χρησιμοποιούν οι περισσότερες γλώσσες προγραμματισμού και θα έχουμε σφάλματα στον υπολογισμό των τιμών του πολυωνύμου.  
H λύση είναι να χρησιμοποιήσουμε τα υπόλοιπα της διαίρεσης με κάποιον μεγάλο αριθμό ώστε να κρατήσουμε τα αποτέλεσμα σε διαχειρίσιμα για το πρόγραμμα μας όρια. 
Ορίζοντας έναν τέτοιο αριθμό $$\mathit{MOD}$$ πρέπει να προσέξουμε να είναι αρκετά μεγάλος ώστε να είναι μικρές οι πιθανότητες collition, να είναι πρώτος σε σχέση με 
τον αριθμό $$C$$ που χρησιμοποιούν τα μονώνυμα στο πολυώνυμο μας και επίσης ο $$C$$ πρέπει να είναι μεγαλύτερος από τη μέγιστη τιμή χαρακτήρα στη συμβολοσειρά ώστε να μην έχουμε collition μεταξύ διαδοχικών χαρακτήρων.
Προσέξτε ότι στην εκφώνηση δεν δίνεται το σύνολο χαρακτήρων που περιέχει η συμβολοσειρά οπότε θα πρέπει ή να υποθέλουμε ότι είναι το $$256$$ ή να το υπολογίσουμε.  
...
Η υλοποίηση που θα δούμε παρακάτω ξεκινά από την χειρότερη περίπτωση (όπου για να έχουμε παλίνδρομο θα έπρεπε να αντιγράψουμε όλο το αλφαριθμητικό εκτός του 
τελευταίου χαρακτήρα στο τέλος 
αντεστραμμένο για να έχουμε παλίνδρομο) και θα κάνουμε επαύξηση του hash value προσθέτοντας στο ένα hash με τον μικρότερο εκθέτη και στο άλλο με τον μεγαλύτερο.  
...
Πολυπλοκότητα $$\mathcal{O}(N)$$. Η λύση αυτή περνά όλα τα test cases.
...
από τη θέση $$Ν$$ έως την τελική θέση $$2N-1$$ να ελέγχουμε αν το $$Z_i$$ ισούται με το υπολοιπόμενο μήκος της συμβολοσειράς. 
