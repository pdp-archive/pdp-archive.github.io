...
Ορίζοντας έναν τέτοιο αριθμό $$\mathit{MOD}$$ πρέπει να προσέξουμε να είναι αρκετά μεγάλος ώστε να είναι μικρές οι πιθανότητες collision, να είναι πρώτος σε σχέση με 
...
να μην έχουμε collision μεταξύ διαδοχικών χαρακτήρων.  
