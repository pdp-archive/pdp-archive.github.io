...
Το πρόβλημα με την προηγούμενη λύση είναι ότι ενώ θέλουμε να δοκιμάσουμε έναν χαρακτήρα κάθε φορά ολισθαίνοντας τα δυo τμήματα του υποψήφιου παλίνδρομου, 
