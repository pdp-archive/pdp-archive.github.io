...
Αφού το $$M = 10.000$$ είναι σχετικά μικρό, μπορούμε να προϋπολογίσουμε όλους τους πρώτους αριθμούς μικρότερους από $$M$$ (χρησιμοποιώντας οποιανδήποτε από τις παραπάνω μεθόδους) και ανάλογα με την είσοδο να τυπώνουμε αυτούς που πρέπει σε $$\mathcal{O}(M)$$ χρόνο και μνήμη (δείτε τον κώδικα [εδώ]({% link_to_source='function_precomputation.cpp' %}).
