...
Μια ενδεικτική παραλλαγή με χρήση dynamic memory allocation μπορείτε να βρείτε [εδώ]({% link_to_source='souvlakia_nlogn_implicit_st_cptr.cc' %}) (οι κόμβοι δημιουργούνται δυναμικά όταν και 
