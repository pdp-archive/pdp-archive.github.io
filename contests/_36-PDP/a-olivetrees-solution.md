...
του παραλληλογράμμου καθορίζεται από την χαμηλότερου ύψους στήλη $$2$$ και το πλάτος από τα $$i,j$$.
...
Οι παραπάνω λύσεις "ορίζουν" τα άκρα του παραλληλογράμμου και υπολογίζουν το ύψος. Εναλλακτικά μπορούμε να 
...
Όταν δεν μπορούμε να επεκτείνουμε άλλο τους δυο δείκτες, έχουμε 
...
μέχρι το σημείο που επεκτεινόταν η $$i$$. Παράδειγμα, έστω ότι έχουμε συναντήσει μια στήλη με ύψος $$H_i$$ που 
επεκτείνεται αριστερά έως τη θέση $$k$$ (προφανώς $$k\leq i$$) και ακολούθως έρχεται μια στήλη με ύψος $$H_j\lt H_i$$. 
