...
αριθμημένη με έναν αριθμό $$i$$ (όπου $$1 \leq i \leq N$$) και έχει μία γνωστή χωρητικότητα $$C_i$$ — δηλαδή πόσες
...
Η πρώτη γραμμή της εισόδου θα περιέχει τρεις ακεραίους αριθμούς $$N$$, $$M$$ και $$Q$$, χωρισμένους ανά δύο με
