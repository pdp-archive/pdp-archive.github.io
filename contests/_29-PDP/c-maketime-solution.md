...
Μπορούμε να δοκιμάσουμε όλα τα δυνατά διαστήματα που είναι $$N(N+1)/2 = \mathcal{O}(N^2)$$ και να μετρήσουμε πόσα στοιχεία περιέχουν. Από αυτά που έχουν λιγότερα ή ίσα από $$K$$, βρίσκουμε αυτό με το μεγαλύτερο μήκος.

Αφού το μέσο μήκος είναι $$\mathcal{O}(N)$$, ο αλγόριθμος θέλει $$\mathcal{O}(N^3)$$ χρόνο και $$\mathcal{O}(M)$$ μνήμη.
...
Η πολυπλοκότητα αυτού του αλγορίθμου είναι $$\mathcal{O}(N^2)$$ και χρειάζεται $$\mathcal{O}(N)$$ μνήμη.
...
Ο αλγόριθμος έχει πολυπλοκότητα $$\mathcal{O}(N\log N)$$ λόγω της ταξινόμησης και χρειάζεται $$\mathcal{O}(N)$$ μνήμη.
...
Το $$j$$ μπορεί να αυξηθεί το πολύ $$N$$ φορές, επομένως η πολυπλοκότητα του αλγορίθμου είναι $$\mathcal{O}(N)$$ και η μνήμη $$\mathcal{O}(N)$$.
