...
{% include code.md solution_name='twingift_simple.cc' %}
...
{% include code.md solution_name='twingift_logarithmic.cc' %}
...
{% include code.md solution_name='twingift_logarithmic_ptr.cc' %}
