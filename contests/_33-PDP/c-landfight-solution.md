...
[^4]: [Ενδεικτική λύση με vector χωρίς διαγραφή στοιχείων]({% include link_to_source.md source_name='landfight_vector_head.cc' %}) 

[^5]: [Ενδεικτική λύση με διπλά συνδεδεμένη λίστα]({% include link_to_source.md source_name='landfight_list.cc' %})

[^6]:[Ενδεικτική λύση με stack]({% include link_to_source.md source_name='landfight_stack.cc' %})
