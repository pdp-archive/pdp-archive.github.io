...
Ο αλγόριθμος αυτός είναι σωστός, καθώς από την παραπάνω παρατήρηση δεν μπορεί να υπάρχει ζευγάρι από όργανα $$a$$ και $$b$$ που να μην είναι ταιριασμένοι οι οργανοπαίχτες σε μη φθίνουσα σειρά.

Ο παρακάτω κώδικας υλοποιεί αυτόν τον αλγόριθμο:

{% include code.md solution_name='orchestras_sort.cc' %}

Η πολυπλοκότητα αυτού του αλγορίθμου είναι $$\mathcal{O}(NK \log (NK))$$.
...
[^2]: Αυτή η τεχνική ονομάζεται *prunning*. Στην χειρότερη περίπτωση η πολυπλοκότητα είναι η ίδια, αλλά στην πράξη οδηγεί σε επιταγχυνση της λύσης.
