...
είναι ότι o $$y$$ πρέπει να έχει τουλάχιστον τα bit που έχει ο $$x$$ αναμμένα
ώστε το $$\texttt{AND}$$ να δώσει $$x$$. Μπορεί να έχει περισσότερα, αλλά όχι
λιγότερα bit αναμμένα. Άρα είναι μεγαλύτερος ή ίσος του $$x$$.
...
ανήκουν σε αυτό είναι όλα τα ζεύγη με $$m$$ bits (όπως στο $$[0, 2^m - 1]$$),
*εκτός* από εκείνα στα οποία $$x < L = 2^k$$, η πιο απλά τα $$x$$ με έως $$k$$
bits. Η γενική μορφή αυτών των $$x, y$$ είναι:
