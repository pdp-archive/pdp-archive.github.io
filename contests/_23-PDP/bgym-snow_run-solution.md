...
Επειδή για κάθε παίκτη ο υπολογισμός της τελικής του κατάταξης με το segment tree γίνεται σε χρόνο $$O(logN)$$ η χρονική πολυπλοκότητα αυτού του αλγορίθμου είναι $$O(NlogN)$$. Η χωρική πολυπλοκότητα είναι $$O(N)$$. Πλέον ο αλγόριθμος είναι περνάει όλα τα testcases.
