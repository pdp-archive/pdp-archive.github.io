...
Υπάρχουν το πολύ $$2$$ επιλογές σε κάθε βήμα και κάθε βήμα παίρνει $$\mathcal{O}(1)$$ χρόνο άρα συνολικά ο αλγόριθμος χρειάζεται $$\mathcal{O}(2^{2N})$$ χρόνο[^1] και $$\mathcal{O}(N)$$ μνήμη. Ο αλγόριθμος περνάει 26 από τα 39 testcases.
...
{% include code.md solution_name='fishboats_brute_force_pruning.cc' start=17 end=20 %}

τότε η λύση περνάει 29 από τα 39 testcases (ολόκληρη η λύση [εδώ]({% include link_to_source.md solution_name='fishboats_brute_force_pruning.cc' %})).
