...
Υπάρχουν το πολύ $$2$$ επιλογές σε κάθε βήμα και κάθε βήμα παίρνει $$\mathcal{O}(1)$$ χρόνο άρα συνολικά ο αλγόριθμος χρειάζεται $$\mathcal{O}(2^{N})$$ χρόνο[^1] και $$\mathcal{O}(N)$$ μνήμη. Ο αλγόριθμος περνάει 26 από τα 39 testcases.
