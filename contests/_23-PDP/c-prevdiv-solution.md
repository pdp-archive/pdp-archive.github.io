...
Αλλά για τα $$A_i = 3$$ έχουμε βρει έναν ακέραιο $$A_j = 6$$ (και $$A_j = 3$$) με $$j > i$$ ώστε $$A_i$$ διαιρεί τον $$A_j$$. Άρα για τους επόμενους ακεραίους, αρκεί να κοιτάξουμε ότι ο $$A_j$$ τους διαιρεί (και αυτό συνεπάγεται ότι και ο $$A_i$$ τους διαιρεί). Πιο συγκεκριμένα, επεκτίνουμε την **Παρατήρηση 1** ως εξής:
