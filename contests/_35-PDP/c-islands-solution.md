...
Η προηγούμενη λύση έκανε δυαδική αναζήτηση για να βρει πότε θα ξοδευτούν $$b$$ εισιτήρια. Το συγκεκριμένο *segment tree*, αν θεωρήσουμε ότι 
υπολογίζουμε τα αθροίσματα πάντα από τη θέση $$1$$, υπολογίζει τα prefix sum του πίνακα εισιτηρίων $$Z$$. Τα prefix sums έχουν αύξουσα 
...
τμήμα του δηλαδή στον κόμβο $$si*2+1$$ (αν δεν μας φτάνουν τα εισιτήρια για να τον προσπεράσουμε) ή στο δεξί κόμβο $$si*2+2$$ 
...
Πιο αναλυτικά: αν $$b<st[si*2+1]$$ θα συνεχίσουμε στον αριστερό απόγονο (καθώς τα εισιτήρια μας δεν μας επιτρέπουν να τον προσπεράσουμε) 
