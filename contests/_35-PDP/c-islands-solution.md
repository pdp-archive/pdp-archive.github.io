...
Η τεχνική που χρησιμοποιήται, αποθηκεύει μόνο την αρχή και το τέλος κάθε διαστήματος 
...
έχουμε ξοδέψει $$b$$ εισιτήρια. Κάθε ερώτημα του προβλήματος θα κάνει λόγω της δυαδικής αναζήτησης $$\log{N}$$ αναζητήσεις στο *segment tree*, κάθε
...
ενώ αν $$b>st[si\cdot 2+2]$$ θα συνεχίσουμε στον δεξιό απόγονο (στην περίπτωση αυτή έχουν μειωθεί τα $$b$$ εισιτήρια μας σε $$b-st[si\cdot 2+1]$$ 
