...
Ο ενδεικτικός κώδικας της λύσης παρουσιάζεται παρακάτω:
...
Χωρίς να είναι απαραίτητο, ισχύει επίσης ότι το παραπάνω είναι ίσο με $$\sum_{j=1}^{K} n_{j} \cdot (2^{j}-2^{j-1})$$, το οποίο και χρησιμοποιούμε στον κώδικα. Αυτό προκύπτει απλώς αναδιατάσσοντας τους όρους του αθροίσματος.
...
Ο παρακάτω ενδεικτικός κώδικας υλοποιεί τις προαναφερθείσες ιδέες.

*Σημείωση:* Ένα κλασικό τρικ όταν κάνουμε binary search, είναι να προσθέτουμε μία πολύ μικρή τιμή, και μία πολύ μεγάλη τιμή, στα δύο άκρα του πίνακα, ώστε να μη χρειάζεται να ελέγχουμε οριακές περιπτώσεις, όπως πχ συμβαίνει αν όλες οι λέξεις είναι μικρότερες από τη ζητούμενη, ή όλες μεγαλύτερες.
