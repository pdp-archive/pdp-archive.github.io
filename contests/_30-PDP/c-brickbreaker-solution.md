...
Υπάρχουν $$Q$$ ερωτήματα και το κάθε ερώτημα θέλει $$\mathcal{O}(NM)$$ χρόνο (μία αναζήτηση κατά βάθος/πλάτος). Συνεπώς, ο αλγόριθμος χρειάζεται $$\mathcal{O}(QNM)$$ χρόνο και $$\mathcal{O}(NM)$$ μνήμη. Αυτό είναι αρκετό για το $$50\%$$ των testcases. 
