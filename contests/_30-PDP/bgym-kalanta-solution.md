...
και να αντικαταστήσουμε όλες τις χρήσεις `A[xx]` με `A(xx)`. Θα βρείτε ολόκληρο τον κώδικα [εδώ]({% include link_to_source.md source_name='kalanta_linear_n_space.cc' %}).
