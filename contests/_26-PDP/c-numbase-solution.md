...
Η αναπαράσταση ενός αριθμού στην βάση $$K$$ μπορεί να υπολογιστεί διαιρώντας με την βάση $$K$$ και κρατώντας το υπόλοιπο με το $$K$$ σε κάθε βήμα. Για παράδειγμα, για την βάση $$K = 10$$ μπορούμε να βρούμε την αναπαράσταση του $$Μ = 562$$ ως εξής:
 1. $$M = 562$$, $$M_0 = M \% 10 = 2$$,
...
**Παρατήρηση:** Παραγοντοποιούμε την αρχική σχέση, $$x(1 + K + K^2 + ... + K^{(n-1)}) = M$$. Επομένως $$x | M$$.
