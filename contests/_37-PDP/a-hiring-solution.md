...
Η ταξινόμηση χρειάζεται $$O(N \log N)$$ χρόνο, συνεπώς ο αλγόριθμος χρειάζεται $$O(N \log N)$$ χρόνο. Μπορούμε επίσης να χρησιμοποιήσουμε τον αλγόριθμο για το ``nth_element``, για να μειώσουμε τον χρόνο σε $$O(N)$$. Δείτε ολόκληρο τον κώδικα [εδώ]({% include link_to_source.md solution_name='hiring_subtask_2.cc' %}) και [εδώ]({% include link_to_source.md solution_name='hiring_subtask_3.cc' %}).
