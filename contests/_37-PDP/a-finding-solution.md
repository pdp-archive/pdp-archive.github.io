...
αν και μόνο αν $$X < A$$. Επομένως, ξανά μπορούμε να βρούμε το $$A$$ ως το πρώτο σημείο που δεν ικανοποείται αυτή η σχέση. Παρατηρήστε ότι σε κάθε επανάληψη κάνουμε μόνο ένα query (αντί για 2).
