...
Μας δίνεται ένας συνδεδεμένος μη-κατευθυνόμενος γράφος ο οποίος έχει την μορφή ενός δέντρου με μία επιπλέον ακμή. Μας ζητείται για κάθε ακμή του γράφου να βρούμε το μήκος του μακρύτερου μονοπατιού μεταξύ δύο κορυφών του γράφου αν αυτή αφαιρεθεί από τον γράφο.
...
Σε αυτό το πρόβλημα υπάρχει ένα σχετικά μικρό πλήθος κόμβων στον κύκλο. Όταν αφαιρούμε μία ακμή από τον κύκλο υπάρχουν τα εξής πιθανά σενάρια:
...
Η εύρεση του κύκλου χρειάζεται $$\mathcal{O}(N)$$ χρόνο και κάθε ερώτημα χρειάζεται $$\mathcal{O}(C^2)$$, όπου $$C$$ είναι το μήκος του κύκλου. Συνεπώς, συνολικά χρειάζεται $$\mathcal{O}(NC^2)$$ χρόνο, που είναι αρκετό για να περάσει το υποπρόβλημα. 
