...
Κάθε ερώτημα χρειάζεται $$\mathcal{O}(C)$$ χρόνο και συνολικά $$\mathcal{O}(NC)$$, που είναι αρκετό για να περάσει το υποπρόβλημα. Ολόκληρος ο κώδικας [εδώ]({% include link_to_source.md solution_name='subtask5.cc' %}).
