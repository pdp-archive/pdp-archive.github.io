...
του διαστήματος αναζήτησης (πίνακας $$A$$), να μην μείνει κανένα. Αυτό θα συμβεί μετά από $$K$$ επαναλήψεις, 
όπου θα έχουμε $$2^{K-K}-1=2^0-1=0$$ στοιχεία. 

Τον αριθμό αυτόν δεν χρειάζεται να τον υπολογίσουμε, 
καθώς αρκεί να καλέσουμε τη `FindCounter` μια και μόνο φορά, για οποιοδήποτε αριθμό δεν υπάρχει στον $$A$$. 
  
Για το υποπρόβλημα αυτό αρκεί να βρούμε πόσοι αριθμοί στο ερώτημα υπάρχουν στον $$A$$ και πόσοι όχι. Κάνοντας αναζήτηση του 
αριστερού άκρου του ερωτήματος με τη χρήση της `lower_bound` και του δεξιού άκρου με την `upper_bound`, 
βρίσκουμε το πρώτο και τελευταίο στοιχείο του ερωτήματος στον πίνακα. Αφαιρούμε τις θέσεις που βρήκαμε και έχουμε το 
πλήθος των υπαρκτών στοιχείων του ερωτήματος στον $$A$$. Τα υπόλοιπα στοιχεία, δεν υπάρχουν στον $$A$$   
