...
### Πώς να τρέξετε τοπικά το site
  ...
  5. Τρέξτε την εντολή `jekyll serve` για να προβάλετε το site από τον υπολογιστή σας. Μερικές χρήσιμες παράμετροι στην εντολή αυτή: `--incremental` για πιό γρηγορότερη μεταγλώττιση του site στις αλλαγές των αρχείων σας και `--host=0.0.0.0` για πρόσβαση μέσω browser από όλο το LAN.
  6. Πηγαίνετε στην σελίδα `localhost:4000` (ή `ip_address:4000`) στον browser σας για να δείτε το site.
...
Ακολουθήστε τα εξής βήματα:
  ...
  2. Δημιουργήστε μία καινούργια εισαγωγή με την εξής δομή: (Δείτε [αυτόν τον φάκελο](https://drive.google.com/open?id=1veWwRRCpvu6jrDo4bulsCcvEw5Csr_t1) για εκφωνήσεις, κώδικες και testcases)
     ...
     {codename - Το όνομα του αρχείου ειδόδου.}:
        ...
        solution: false
        solution_author: {Συγγραφείς της λύσης χωρισμένοι με κόμμα, π.χ. "Νικόλαος Παπασπύρου, Δημήτριος Φωτάκης"}
        codes_in_git: false
