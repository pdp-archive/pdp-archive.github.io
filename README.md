...
### Πώς να τρέξετε τοπικά το site
  ...
  4. Τρέξτε την εντολή `jekyll serve` για να προβάλετε το site από τον υπολογιστή σας. Μερικές χρήσιμες παράμετροι στην εντολή αυτή: `--incremental` για πιό γρηγορότερη μεταγλώττιση του site στις αλλαγές των αρχείων σας και `--host=0.0.0.0` για πρόσβαση μέσω browser από όλο το LAN.
