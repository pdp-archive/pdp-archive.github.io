...
### Πώς να τρέξετε τοπικά το site
  ...
  4. Τρέξτε την εντολή `bundle exec jekyll serve` για να προβάλετε το site από τον υπολογιστή σας. Μερικές επιπλέον χρήσιμες παράμετροι στην εντολή αυτή: `--incremental` για γρηγορότερη μεταγλώττιση του site στις αλλαγές των αρχείων σας και `--host=0.0.0.0` για πρόσβαση μέσω browser από όλο το LAN.
...
Για να προσθέσετε κώδικα και να ελέγξετε ότι περνάει τα testcases, ακολουθήστε τις οδηγίες στο [`_includes/source_code/README.md`](/_includes/source_code/README.md). Αφού προσθέσετε την πρώτη λύση, αλλάξτε το `codes_in_git: true` στο αντίστοιχο `_data/contests/ΧΧ-PDP.yml`.
